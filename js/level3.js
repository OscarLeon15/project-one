...
window.onload = function(){
  let c = document.getElementById("myCanvasLevel3");
...
let goal = new Image();
goal.src = "../images/all-dragonballs.png";
...
x2: 20, y2: -80,//vertical left
x3: 620, y3: 20,//vertical right
x4: 320, y4: 220,//horizontal
x5: 920, y5: 20,//vertical right
x6: 920, y6: 20,//horizontal
width: 80,
height: 80,
dx: 10, dy: 10
}
function moveRight(){
if(theHuricane.x1 < 10){theHuricane.x1 += 1000;}
...
huricane = new Image();
huricane.src = "../images/frieza.png";
huricane.onload = function () {
    ...
    ctx.drawImage(huricane, theHuricane.x5, theHuricane.y5, theHuricane.width, theHuricane.height);
    ctx.drawImage(huricane, theHuricane.x6, theHuricane.y6, theHuricane.width, theHuricane.height);
...
let coin = new Image();
coin.src = "../images/dragonball.png";
...
initialPos: function() {this.x = 410, this.y = 520}
}
class Boat {
  constructor(){
      this.x = 410;
      ...
      this.width = 80;
      this.height = 80;
      this.img = "../images/helicopter.png";
  }
  drawBoat(){
...
if (theBoat.x < theHuricane.x5 + theHuricane.width && theBoat.x + theBoat.width > theHuricane.x5 &&
  theBoat.y < theHuricane.y5 + theHuricane.height &&
  theBoat.height + theBoat.y > theHuricane.y5){
  theBoat.x = 410;
  theBoat.y = 520;
}
if (theBoat.x < theHuricane.x6 + theHuricane.width && theBoat.x + theBoat.width > theHuricane.x6 &&
  theBoat.y < theHuricane.y6 + theHuricane.height &&
  theBoat.height + theBoat.y > theHuricane.y6){
  theBoat.x = 410;
  theBoat.y = 520;
}
}// end of checkLimits()
