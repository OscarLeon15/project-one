...
window.onload = function(){
  let c = document.getElementById("myCanvasLevel2");
...
if(theHuricane.y2 > 600){theHuricane.y2 -= 600;}
if(theHuricane.y3 > 600){theHuricane.y3 -= 600;}
...
huricane = new Image();
huricane.src = "../images/squid2.png";
